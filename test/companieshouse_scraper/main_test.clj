...
;ALEXANDER & CO ESTATE AGENTS LTD
;ALEXANDER & CO ESTATES LIMITED
;ALEXANDER & CO FORMATIONS LIMITED
;ALEXANDER & CO. LETTINGS LIMITED
;ALEXANDER & CO. LETTINGS & MANAGEMENT LIMITED
;ALEXANDER AND COLINS LTD
;ALEXANDER & CO LLP
;ALEXANDER AND COMPANY (FOOTWEAR) LIMITED
(companieshouse-scraper.main/search "ALEXANDER & CO. (ACCOUNTANCY) LIMITED" 10
				    #(do (. Thread sleep (rand 1000))
					 (println (:name %))))